<header class="main-header">
    <div class="container">
        <h1 class="page-title"><?php echo $type; ?> </h1>
    </div>
</header>
        ...
        <div class="col-md-4">
          <section>
              ...
              <table class="table table-striped">
                <tr >
                  <th>
                    <a href="<?php echo base_url().'messages'?>" data-href="<?php echo base_url().'profile'?>" title="messages">
                    You have 
                    <span class="badge tick"><?php echo $countNumber; ?></span>
                    message(s)</a>
                  </th>
                </tr>
                <tr>
                  <th>
                    <a href="<?php echo base_url().'family-matches'?>" data-href="<?php echo base_url().'profile'?>">
                    You have 
                    <span class="badge fam"><?php echo $countFamilyMatches; ?></span>
                    family matche(s)</a>
                  </th>
                </tr>
                <tr>
                  <th>
                    <a href="<?php echo base_url().'nanny-matches'?>" data-href="<?php echo base_url().'profile'?>">
                    You have 
                    <span class="badge nanny"><?php echo $countNannyMatches; ?></span>
                    nanny matche(s)
                    </a>
                  </th>
                </tr>
          ...
          <section>
              <hr>
              <a href="<?php echo base_url().'profile/edit/id/'.$id;?>" class="btn btn-ar btn-block btn-warning" title="Edit your profile">Edit your profile</a>
              
              <a href="<?php echo base_url().'create-job-listing';?>" class="btn btn-ar btn-block btn-primary" title="Create a job listing">Create a job listing</a>
                ...
                <table class="table table-striped">
                  ...
                  <th>
                    ...
                    <th>
                      <a href="<?php echo base_url().'family-matches'?>" data-href="<?php echo base_url().'profile'?>">
                      You have 
                      <span class="badge fam">
                        <?php if(isset($address)): ?>
                          0
                        <?php else: ?>
                          <?php echo $countFamilyMatches; ?>
                        <?php endif; ?>
                      </span>
                      family matche(s)</a>
                    </th>
