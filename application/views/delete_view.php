...
<div class="delete-block">
  ...
  <?php foreach($getMyMessage as $msg): ?>
    <a href="#" id="deleteBtn" data-deleteid="<?php echo $msg->msg_id; ?>" data-href="<?php echo base_url().'delete/msg'?>" class="btn btn-primary pull-right" >Delete</a>
  <?php endforeach; ?>
</div>