...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    autoLoadFamily = setInterval(function(){loadAjaxFamily();}, 3000);     
    autoLoadNanny = setInterval(function(){loadAjaxNanny();}, 3000)
  });
  ...
  function loadAjax(){
    $.ajax({
      ...
      success: function(data){
        $(".tick").html(data.StatusMessages);
      }
    });
  }
  
  function loadAjaxFamily(){
    $.ajax({
      type: "get",
      url: $(this).data("href"),
      dataType: "JSON",
      data: {
        family: "family_success"
      },     				
      success: function(data){
        $(".fam").html(data.StatusFamily);
      }
    });
  }
  
  function loadAjaxNanny(){
     $.ajax({
      type: "get",
      url: $(this).data("href"),
      dataType: "JSON",
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><?php echo $query->first_name; ?> <?php echo $query->last_name; ?></td>
												...
												<tr>
                            <th>Email address</th>
                            <td><?php echo $query->email_address; ?></td>
                        </tr>
												<tr>
                            <th>Address</th>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if($query->suburb_postcode == NULL): ?>
                                <?php echo "No Suburb/Postcode yet";?>
                              <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->number_of_children == NULL): ?>
                              <?php echo "No number of children yet";?>
                            <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->boys == 0): ?>
                              <?php echo "No number of boys yet"; ?>
                            <?php else: ?>
                              <?php echo $query->boys; ?>
                            <?php endif; ?>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->girls == 0): ?>
                              <?php echo "No number of girls yet"; ?>
                            <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <?php if($daysPerWeeks == NULL || $daysPerWeeks == 0): ?>
                              <?php echo "No available days per week yet";?>
                            <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->hours_required == NULL): ?>
                              <?php echo "No hours required yet";?>
                            <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->childs_activities == NULL): ?>
                              <?php echo "No child activities yet";?>
                            <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->additional_comments == NULL): ?>
                              <?php echo "No additional comments yet"; ?>
                            <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if($query->date_of_birth == "0000-00-00"): ?>
                                <?php echo "No date of birth selected yet";?>
                              <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($query->mummy_shared_nanny == 0):?>
                              <?php echo "No mummy nanny/shared nanny yet";?>
                            ...
                            <?php endif; ?>
												...
												<tr>
													...
													<td>
														<?php if($query->mummy_nanny_child_age == NULL || $query->mummy_nanny_child_age == 0): ?>
															<?php echo "No mummy nanny with child aged yet";?>
														<?php else: ?>
                         ...
                         <tr>
                            ...
                            <td>
                              <?php if($query->number_of_children_prepared_to_care_for == NULL ||$query->number_of_children_prepared_to_care_for == 0): ?>
                                <?php echo "No number of children prepared to care for";?>
                              <?php else: ?>
                         ...
                         <tr>
                            ...
                            <td>
                              ...
                              <?php if($agesOfChildrens == NULL || $agesOfChildrens == 0): ?>
                                <?php echo "No ages of children yet";?>
                              <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if($query->have_drivers_licence == NULL || $query->have_drivers_licence == 0): ?>
                                <?php echo "No driver's licence yet"; ?>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if($query->have_first_aid_certificate == NULL || $query->have_first_aid_certificate == 0): ?>
                                <?php echo "No first aid certificate yet"; ?>
                         ...
                         <tr>
                            ...
                            <td>
                              <?php if($query->registered_carrer == NULL || $query->registered_carrer == 0): ?>
                                <?php echo "No registered carrer yet"; ?>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if($query->yr_exp_as_nanny == NULL || $query->yr_exp_as_nanny == 0 ):?>
                                <?php echo "No experience as a nanny yet";?>
                              <?php else: ?>
                         ...
                         <tr>
                            ...
                            <td>
                              <?php if($query->multiple_children_exp == NULL || $query->multiple_children_exp == 0): ?>
                                <?php echo "No multiple children experience yet"; ?>
                         ...
                         <tr>
                            ...
                            <td>
                              <?php if($query->a_little_about_myself == NULL):?>
                                <?php echo "No a little bit about myself yet.";?>
                              <?php else: ?>
