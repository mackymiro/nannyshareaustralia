...
function __initialize($props = array()){
  #Account information
  $config["business"] = 'sales@nannyshareaustralia.com.au'; //Account email or id
  ...
  $config["currency_code"] = 'AUD'; //http://bit.ly/anciiH
  $config["disp_tot"] = 'Y';
  #Page Layout -->
  $config["cpp_header_image"] = ''; //Image header url [750 pixels wide by 90 pixels high]
  ...
  $config["return"] = 'Return to NannyShareAustralia'; //The URL to which PayPal redirects buyersÃ¢â‚¬â„¢ browser after they complete their payments.
  $config["cancel_return"] = 'Cancel and return to NannyShareAustralia'; //Specify a URL on your website that displays a Ã¢â‚¬Å“Payment CanceledÃ¢â‚¬Â page.
